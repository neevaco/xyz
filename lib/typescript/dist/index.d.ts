...
export const DefaultApiFactory: (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) => {
     ...
     * @throws {RequiredError}
     */
    apiV1BlockchainsGet(options?: any): Promise<BlockchainInfo[]>;
    /**
     *
     * @summary Get a collection by its contract address.
     * @param {string} contractAddress A hex address for a blockchain contract.
     ...
     * @throws {RequiredError}
     */
    apiV1CollectionsContractAddressGet(contractAddress: string, chainID?: string, options?: any): Promise<Collection[]>;
    /**
     *
     * @summary Get tokens by contract address.
     * @param {string} contractAddress A hex address for a blockchain contract.
     ...
     * @throws {RequiredError}
     */
    apiV1TokensContractAddressGet(contractAddress: string, chainID?: string, page?: number, limit?: number, options?: any): Promise<Token[]>;
    /**
     *
     * @summary Get a token by its contract address and token ID.
     * @param {string} contractAddress A hex address for a blockchain contract.
     ...
     * @throws {RequiredError}
     */
    apiV1TokensContractAddressTokenIDGet(contractAddress: string, tokenID: string, chainID?: string, options?: any): Promise<Token[]>;
    /**
     *
     * @summary Returns a list of transfer transactions on a specified token.
     * @param {string} contractAddress A hex address for a blockchain contract.
     ...
     * @throws {RequiredError}
     */
    apiV1TokensContractAddressTokenIDTransfersGet(contractAddress: string, tokenID: string, chainID?: string, options?: any): Promise<TokenEvents>;
    /**
     *
     * @summary Get a wallet by a wallet address
     * @param {string} walletAddress A hex string referencing a public wallet address.
     ...
     * @throws {RequiredError}
     */
    apiV1WalletsWalletAddressGet(walletAddress: string, chainID?: string, options?: any): Promise<Wallet[]>;
};
/**
