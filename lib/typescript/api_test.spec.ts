...
describe("DefaultApi", () => {
  ...
  test("apiV1CollectionsGet", () => {
    ...
    return expect(instance.apiV1CollectionsGet(contractAddress, query, {})).resolves.toBe(null)
  })
  ...
  test("apiV1TokensGet", () => {
    ...
    const tokenID: string = "tokenID_example"
    const query: string = "query_example"
    return expect(instance.apiV1TokensGet(contractAddress, tokenID, query, {})).resolves.toBe(null)
  })
