...
const BASE_PATH = "https://virtserver.swaggerhub.com/neevaxyz/jdtest/0.0.1".replace(/\/+$/, "");
...
export const DefaultApiFp = function(configuration?: Configuration) {
    return {
        ...
        apiV1CollectionsGet(contractAddress?: string, query?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<Collection>> {
            const localVarFetchArgs = DefaultApiFetchParamCreator(configuration).apiV1CollectionsGet(contractAddress, query, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        apiV1TokensGet(contractAddress?: string, tokenID?: string, query?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<Token>> {
            const localVarFetchArgs = DefaultApiFetchParamCreator(configuration).apiV1TokensGet(contractAddress, tokenID, query, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const DefaultApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1CollectionsGet(contractAddress?: string, query?: string, options?: any) {
            return DefaultApiFp(configuration).apiV1CollectionsGet(contractAddress, query, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get tokens by contract address
         ...
         * @throws {RequiredError}
         */
        apiV1TokensGet(contractAddress?: string, tokenID?: string, query?: string, options?: any) {
            return DefaultApiFp(configuration).apiV1TokensGet(contractAddress, tokenID, query, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get a Wallet
...
export class DefaultApi extends BaseAPI {
     ...
     * @memberof DefaultApi
     */
    public apiV1CollectionsGet(contractAddress?: string, query?: string, options?: any) {
        return DefaultApiFp(this.configuration).apiV1CollectionsGet(contractAddress, query, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof DefaultApi
     */
    public apiV1TokensGet(contractAddress?: string, tokenID?: string, query?: string, options?: any) {
        return DefaultApiFp(this.configuration).apiV1TokensGet(contractAddress, tokenID, query, options)(this.fetch, this.basePath);
    }
